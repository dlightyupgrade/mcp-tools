...
def register_quarterly_team_report_tool(mcp: FastMCP):
    ...
    def quarterly_team_report(
        ...
        ⚠️ **ALPHA DEVELOPMENT STAGE**: This tool is in active development and not suitable for official use.
        Manual validation of all outputs is required. Not suitable for performance reviews or business decisions.
...
> - **Not Suitable For**: Official reporting, performance reviews, or business decisions
...
- **Internal use only**: Not suitable for external reporting or business decisions

*Generated using MCP Tools Quarterly Reporting (Alpha Development Version) with real-time data collection*
""",
                },
